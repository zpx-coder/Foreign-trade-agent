...
/enterprise                  → views/enterprise/EnterpriseView.vue
/enterprise/edit             → views/enterprise/EnterpriseEdit.vue

/products                    → views/product/ProductListView.vue
/products/create             → views/product/ProductCreate.vue
/products/:id/edit           → views/product/ProductEdit.vue

/icps                        → views/icp/IcpListView.vue
/icps/create                 → views/icp/IcpCreate.vue
/icps/:id                    → views/icp/IcpDetail.vue

/customers                   → views/customer/CustomerListView.vue
/customers/:id               → views/customer/CustomerDetail.vue

/email/templates             → views/email/TemplateListView.vue
/email/templates/create      → views/email/TemplateCreate.vue
/email/templates/:id/edit    → views/email/TemplateEdit.vue
/email/campaigns             → views/email/CampaignListView.vue
/email/campaigns/create      → views/email/CampaignCreate.vue
/email/campaigns/:id         → views/email/CampaignDetail.vue

/settings                    → views/settings/SettingsView.vue
/settings/members            → views/settings/MemberListView.vue  (超管/管理员)
```
...
router.beforeEach((to, from, next) => {
  ...
  // 权限路由：/settings/members 仅超管/管理员可访问
  if (to.path === '/settings/members' && !authStore.canManageMembers) {
...
export const navMenuItems = [
  { path: '/dashboard',   title: '工作台',   icon: 'Monitor',    roles: ['*'] },
  { path: '/icps',         title: '客户画像', icon: 'PictureFilled', roles: ['*'] },
  { path: '/customers',    title: '客户管理', icon: 'UserFilled',  roles: ['*'] },
  { path: '/email/templates', title: '邮件营销', icon: 'Message', roles: ['*'],
    children: [
      { path: '/email/templates', title: '邮件模板' },
      { path: '/email/campaigns', title: '发送任务' },
    ]
  },
  { path: '/products',     title: '产品管理', icon: 'Goods',      roles: ['*'] },
  { path: '/enterprise',   title: '企业资料', icon: 'OfficeBuilding', roles: ['*'] },
  { path: '/settings',     title: '系统设置', icon: 'Setting',     roles: ['super_admin', 'admin'] },
]
```
